...
public class CreateAppointmentController extends GenericAppointmentController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			Appointment appointment = toObject(false);
			Appointment newAppointment = AppointmentService.getService().create(appointment);
			manageAppointmentController.refresh();
